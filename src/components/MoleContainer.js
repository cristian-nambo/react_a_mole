...
// A handleClick function that will increment the score by 1 and immediately 
// set the clicked-on mole to no longer display (we will pass this down only to Mole components)
